...
try:
   ...
   print op,err
   op,err= execute_command('sudo wp core install --url="' +  host + '"  --title="Your Blog Title" --admin_user="' + username + '" --admin_password="' +  password + '" --admin_email="' + email + '" --path="/var/www/html/" --allow-root')
   print op,err
   '''
