...
LETS_ENCRYPT_DEFAULT = 'Enter email address'
LETSENCRYPT_ALREADY_EXISTING = 'You have an existing certificate that has exactly the same domains or certificate name you requested'
CERTBOT_ANOTHER_INSTANCE = 'Another instance of Certbot is already running.'
REDIRECT_TO_HTTPS = 'Please choose whether or not to redirect HTTP traffic to HTTPS'
